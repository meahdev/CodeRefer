...
class StickyHeadersTable extends StatefulWidget {
  StickyHeadersTable({
    ...
    // this.legendCellBackGroundColor = Colors.white,
  ...
  // final Color? legendCellBackGroundColor;
  final Widget Function(int columnIndex) columnsTitleBuilder;
  final Widget Function(int columnIndex) headerWidgetBuilder;
  ...
  final Function(int columnIndex) onTapRemove;
          ...
          children: <Widget>[
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                /// 157 height based header-view image  ,button  and sized-box
                height: 157 + widget.cellDimensions.headerViewHeight,
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                    onPressed: () {
                                      widget.onTapRemove(i);
                                    },
                                    child: Text(widget.buttonName ?? '',style: TextStyle(fontSize: 12),)),
                              ),
                              SizedBox(
                                height: 10,
                              ),
                              widget.headerWidgetBuilder(i),
                              SizedBox(
                                height: 3,
                              ),
                              Container(
                                ...
                                height:
                                widget.cellDimensions.headerViewHeight,
                                alignment:
                      ...
                      children: List.generate(
                        widget.rowsLength,
                          ...
                          child: Container(
                            ...
                            width: widget.cellDimensions.stickyLegendWidth,
                            height:widget.cellDimensions.rowHeights![i],
